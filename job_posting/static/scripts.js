// Debug: ensure this file is evaluated
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const salaryToggleInput = document.getElementById('toggle-salary');
    ...
    function initTheme() {
        ...
        // Force the model to gemini-2.5-pro-preview-05-06
        if (modelSelect) {
            modelSelect.value = "gemini-2.5-pro-preview-05-06";
        }
    }
    ...
    async function generateJobPosting(event) {
        ...
        try {
            ...
            reader.releaseLock();
            // Hide spinner after streaming completes
