// frontend/src/services/job-posting-service.ts
import { 
...
export const JobPostingService = {
   ...
   */
  generateJobPosting: async (data: JobPostingCreateRequest): Promise<JobPostingResponse> => {
   ...
   */
  saveJobPosting: async (data: JobPostingCreateRequest & { generated_content: string }): Promise<JobPostingResponse> => {
    const token = localStorage.getItem('access_token');
    const tenantId = localStorage.getItem('tenant_id');
