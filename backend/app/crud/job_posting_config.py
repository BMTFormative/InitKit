...
def get_job_posting_config(session: Session) -> JobPostingConfig | None:
    """
...
def update_job_posting_config(session: Session, config_update: JobPostingConfig) -> JobPostingConfig:
    """
